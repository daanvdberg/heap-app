	...
	useEffect(() => {
		...
		async function getToken() {
			try {
				...
				console.group('Error fetching token');
				console.error(e);
				console.groupEnd();
			}
		}
				...
				<div className='container max-w-7xl m-auto px-6'>
					<div className='flex flex-wrap items-center justify-between gap-6 md:py-3 md:gap-0'>
						<div className='w-full px-6 flex justify-between lg:w-max md:px-0'>
							<a href='src/components/App/App#index.ts' aria-label='logo'
						...
						<div
							...
							<div className='text-gray-600 lg:pr-4'>
								<ul className='space-y-6 tracking-wide font-medium text-lg lg:text-sm lg:flex lg:space-y-0'>
									...
									<li>
										<a href='/wishlist' className='block md:px-4 transition hover:text-sky-700'>
											<span>Wishlist</span>
										</a>
									</li>
								</ul>
